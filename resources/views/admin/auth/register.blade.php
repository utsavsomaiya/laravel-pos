...
@section('content')
    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="form-group mb-3">
                <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Email" name="email" value="{{ old('email') }}" required>
                @error('email')
                    <div class="mt-2 text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                <input type="password" class="form-control form-control-lg @error('password_confirmation') is-invalid @enderror" placeholder="Confirm Password" name="password_confirmation" required>
    ...
    <div>
        <a href="/admin" class="btn">Sign In</a>
    </div>
@endsection
